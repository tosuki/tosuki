...
## Skills
- **Languages:** JavaScript, TypeScript, Python, C, C++, Go, Lua, Java, Kotlin 
- **Frameworks:** React, Next.js, Express, Spring Boot
- **Databases:** PostgreSQL, MySQL, MongoDB, SQLite, Redis
- **Tools & Platforms:** Docker, Kubernetes, Git, GitHub, Linux, Nginx, Apache
- **Interests:** Web Development, Low-level Systems, Networking, Automation
- **Cloud** AWS
